...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = ["/game-monetization-policy", "", "/games", "/blog", "/about", "/contact", "/privacy-policy", "/terms-of-service", "/developers", "/developers/getting-started", "/developers/docs", "/developers/sdk", "/developers/requirements", "/developers/guidelines", "/developers/unity", "/developers/html5", "/developers/builds", "/developers/media", "/developers/publishing", "/developers/monetization", "/developers/faq", "/developers/support"].map((route) => ({
